...
This directory contains the optimized OpenClaw template with SPARC methodology support and batch tools integration.
...
- **Ruflo integration** for orchestration
...
The template is automatically installed when initializing a new Ruflo project. To manually install:
...
- Main commands for Ruflo integration
...
After installation, the commands are available in OpenClaw:

- Type `/` to see all available commands
- Use `/sparc` for SPARC methodology
- Use `/claude-flow-*` for Ruflo features
