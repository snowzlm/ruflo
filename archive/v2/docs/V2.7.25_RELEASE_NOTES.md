...
```bash
ruflo memory store "test" "Clean npx experience!"
...
**For Users:**
1. Try npx for quick testing: `ruflo memory store "test" "value"`
2. Install globally for semantic search: `npm install -g github:snowzlm/ruflo`
...
- **Repository:** https://github.com/ruvnet/openclaw-flow
