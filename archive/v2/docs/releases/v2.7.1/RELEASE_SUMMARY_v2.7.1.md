...
ruflo --version  # Should show: v2.7.1
```
...
```bash
# Train a pattern
ruflo hooks neural-train --pattern-type coordination --epochs 50

# Retrieve patterns
ruflo hooks neural-patterns --action analyze

# Get statistics
ruflo hooks neural-patterns --action stats --pattern-type coordination
```

### Resources
- **npm**: https://www.npmjs.com/package/claude-flow
- **GitHub**: https://github.com/ruvnet/openclaw-flow
- **Issue #827**: https://github.com/snowzlm/ruflo/issues/827
- **Documentation**: https://github.com/snowzlm/ruflo/tree/main/docs
