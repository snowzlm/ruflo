...
### Workflow File
`/workspaces/openclaw-flow/.github/workflows/ci.yml`
...
### Workflow File
`/workspaces/openclaw-flow/.github/workflows/rollback-manager.yml`
...
### Workflow File
`/workspaces/openclaw-flow/.github/workflows/integration-tests.yml`
...
1. **Fix duplicate "test" key in package.json** (CI/CD blocker)
   - File: `/workspaces/openclaw-flow/package.json`
...
**Report Generated By**: OpenClaw Quality Analyzer
...
- CI/CD Pipeline: https://github.com/snowzlm/ruflo/actions/runs/19621632521
- Rollback Manager: https://github.com/snowzlm/ruflo/actions/runs/19622456012
- Integration Tests: https://github.com/snowzlm/ruflo/actions/runs/19622447176

### Key Files to Edit
1. `/workspaces/openclaw-flow/package.json` - Remove duplicate test key
