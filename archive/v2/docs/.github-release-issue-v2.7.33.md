...
This major release brings **three transformative feature sets** to Ruflo:
...
### CLI Status ✅
```bash
✅ npx ruflo --version → v2.7.33
✅ npx ruflo mcp status → Operational
✅ npx ruflo memory stats → ReasoningBank data
...
npx ruflo mcp call tools/search '{"query": "memory", "detailLevel": "basic"}'

# Tools load automatically on first invocation
npx ruflo mcp call memory_store '{"key": "test", "value": "data"}'
```
...
### Documentation
- Main docs: https://github.com/snowzlm/ruflo
