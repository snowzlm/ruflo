...
### Issue
After v2.7.26 release, users experienced `ENOTEMPTY` errors when running `npx ruflo` commands:
...
❌ Failed after 3 attempts. Please try:
   ...
   2. Use global installation: npm install -g ruflo
   3. Report issue: https://github.com/snowzlm/ruflo/issues/856
```
...
- **GitHub Issue**: [#856](https://github.com/snowzlm/ruflo/issues/856)
...
For CI/CD pipelines using `npx ruflo`:
...
**Full Changelog**: [v2.7.26...v2.7.27](https://github.com/snowzlm/ruflo/compare/v2.7.26...v2.7.27)
