...
**Problem:** `ruflo` was failing in GitHub Codespaces and minimal Docker environments with better-sqlite3 build errors.
...
npm view ruflo@alpha dependencies | grep agentdb
...
- [GitHub Issue #835](https://github.com/ruvnet/openclaw-flow/issues/835) - MCP stdio corruption fix

## 🎉 Summary

The remote installation issue is now **fully resolved**. Users can run `ruflo` without build tools in GitHub Codespaces, minimal Docker containers, and any remote environment.
