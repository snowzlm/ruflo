# ruflo v2.7.26 - Final Release Summary
...
- `ruflo@2.7.26` - Production-ready with clean UX
...
ruflo memory list                   # ✅
ruflo memory export output.json     # ✅
ruflo memory import data.json       # ✅
```
