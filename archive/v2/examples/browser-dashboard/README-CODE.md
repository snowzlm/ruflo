...
└─────────────────────────────────────────────────────────────┘
                           ↓ stdio (JSON-RPC 2.0)
┌─────────────────────────────────────────────────────────────┐
│         Ruflo MCP Server (npx ruflo mcp)        │
│  • 90+ MCP tools                                            │
│  • Swarm orchestration                                      │
│  • Agent management                                         │
...
```bash
cd /workspaces/openclaw-flow/examples/browser-dashboard
...
- Actual agent spawning via `mcp__ruflo__agents_spawn_parallel`
...
**This is a production-ready browser IDE powered by Ruflo MCP + Monaco Editor!** 🚀
