...
This directory contains comprehensive integration tests for benchmarking ruflo's SPARC modes and swarm strategies.
...
- ruflo installed and accessible
- Non-interactive mode support in ruflo