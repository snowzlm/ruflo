...
### Core SPARC Commands
- `ruflo sparc modes`: List all available SPARC development modes
- `ruflo sparc run <mode> "<task>"`: Execute specific SPARC mode for a task
- `ruflo sparc tdd "<feature>"`: Run complete TDD workflow using SPARC methodology
- `ruflo sparc info <mode>`: Get detailed information about a specific mode

### Batchtools Commands (Optimized)
- `ruflo sparc batch <modes> "<task>"`: Execute multiple SPARC modes in parallel
- `ruflo sparc pipeline "<task>"`: Execute full SPARC pipeline with parallel processing
- `ruflo sparc concurrent <mode> "<tasks-file>"`: Process multiple tasks concurrently
...
ruflo sparc run spec-pseudocode "Define user authentication requirements" --parallel
```
...
ruflo sparc run spec-pseudocode "Create authentication flow pseudocode" --batch-optimize
```
...
ruflo sparc run architect "Design authentication service architecture" --parallel
```
...
ruflo sparc tdd "implement user authentication system" --batch-tdd
```
...
ruflo sparc run integration "integrate authentication with user management" --parallel
```
...
1. **MCP**: `mcp__ruflo@alpha__swarm_init` (coordination setup)
2. **MCP**: `mcp__ruflo@alpha__agent_spawn` (planning agents)
3. **MCP**: `mcp__ruflo@alpha__task_orchestrate` (task coordination)
...
7. **MCP**: `mcp__ruflo@alpha__memory_usage` (store results)

**❌ WRONG Workflow:**

1. **MCP**: `mcp__ruflo@alpha__terminal_execute` (DON'T DO THIS)
...
[Single Message with BatchTool]:
  ...
  mcp__ruflo@alpha__swarm_init { topology: "mesh", maxAgents: 6 }
  mcp__ruflo@alpha__agent_spawn { type: "researcher" }
  mcp__ruflo@alpha__agent_spawn { type: "coder" }
  mcp__ruflo@alpha__agent_spawn { type: "code-analyzer" }
  mcp__ruflo@alpha__agent_spawn { type: "tester" }
  mcp__ruflo@alpha__agent_spawn { type: "task-orchestrator" }
...
```javascript
Message 1: mcp__ruflo@alpha__swarm_init
...
openclaw mcp add ruflo@alpha ruflo mcp start
```
...
- Use the `mcp__ruflo@alpha__swarm_init` tool to set up coordination topology
- Choose: mesh, hierarchical, ring, or star
- This creates a coordination framework for OpenClaw's work

**Spawn agents:**

- Use `mcp__ruflo@alpha__agent_spawn` tool to create specialized coordinators
- Agent types represent different thinking patterns, not actual coders
- They help OpenClaw approach problems from different angles

**Orchestrate tasks:**

- Use `mcp__ruflo@alpha__task_orchestrate` tool to coordinate complex workflows
...
- `mcp__ruflo@alpha__swarm_init` - Set up coordination topology for OpenClaw
- `mcp__ruflo@alpha__agent_spawn` - Create cognitive patterns to guide OpenClaw
- `mcp__ruflo@alpha__task_orchestrate` - Break down and coordinate complex tasks

### Monitoring Tools:

- `mcp__ruflo@alpha__swarm_status` - Monitor coordination effectiveness
- `mcp__ruflo@alpha__agent_list` - View active cognitive patterns
- `mcp__ruflo@alpha__agent_metrics` - Track coordination performance
- `mcp__ruflo@alpha__task_status` - Check workflow progress
- `mcp__ruflo@alpha__task_results` - Review coordination outcomes

### Memory & Neural Tools:

- `mcp__ruflo@alpha__memory_usage` - Persistent memory across sessions
- `mcp__ruflo@alpha__neural_status` - Neural pattern effectiveness
- `mcp__ruflo@alpha__neural_train` - Improve coordination patterns
- `mcp__ruflo@alpha__neural_patterns` - Analyze thinking approaches

### GitHub Integration Tools (NEW!):

- `mcp__ruflo@alpha__github_swarm` - Create specialized GitHub management swarms
- `mcp__ruflo@alpha__repo_analyze` - Deep repository analysis with AI
- `mcp__ruflo@alpha__pr_enhance` - AI-powered pull request improvements
- `mcp__ruflo@alpha__issue_triage` - Intelligent issue classification
- `mcp__ruflo@alpha__code_review` - Automated code review with swarms

### System Tools:

- `mcp__ruflo@alpha__benchmark_run` - Measure coordination efficiency
- `mcp__ruflo@alpha__features_detect` - Available capabilities
- `mcp__ruflo@alpha__swarm_monitor` - Real-time coordination tracking
...
- Tool: `mcp__ruflo@alpha__swarm_init`
- Parameters: `{"topology": "mesh", "maxAgents": 5, "strategy": "balanced"}`
- Result: Creates a mesh topology for comprehensive exploration

**Step 2:** Define research perspectives

- Tool: `mcp__ruflo@alpha__agent_spawn`
...
- Tool: `mcp__ruflo@alpha__task_orchestrate`
...
- Tool: `mcp__ruflo@alpha__github_swarm`
...
4. **ALL AGENTS MUST USE COORDINATION TOOLS** - Every spawned agent MUST use ruflo@alpha hooks and memory
...
Message 1: [BatchTool]
  // MCP coordination setup
  - mcp__ruflo@alpha__swarm_init
  - mcp__ruflo@alpha__agent_spawn (researcher)
  - mcp__ruflo@alpha__agent_spawn (coder)
  - mcp__ruflo@alpha__agent_spawn (code-analyzer)
  - mcp__ruflo@alpha__agent_spawn (tester)
  - mcp__ruflo@alpha__agent_spawn (task-orchestrator)
...
[BatchTool]:
  ...
  - mcp__ruflo@alpha__agent_spawn { type: "system-architect", name: "System Designer" }
  - mcp__ruflo@alpha__agent_spawn { type: "coder", name: "API Developer" }
  - mcp__ruflo@alpha__agent_spawn { type: "coder", name: "Frontend Dev" }
  - mcp__ruflo@alpha__agent_spawn { type: "code-analyzer", name: "DB Designer" }
  - mcp__ruflo@alpha__agent_spawn { type: "tester", name: "QA Engineer" }
  - mcp__ruflo@alpha__agent_spawn { type: "researcher", name: "Tech Lead" }
  - mcp__ruflo@alpha__agent_spawn { type: "task-orchestrator", name: "PM" }
  - TodoWrite { todos: [multiple todos at once] }

STEP 2: PARALLEL TASK EXECUTION (Single Message!)
[BatchTool]:
  - mcp__ruflo@alpha__task_orchestrate { task: "main task", strategy: "parallel" }
  - mcp__ruflo@alpha__memory_usage { action: "store", key: "init", value: {...} }
...
[BatchTool - Message 1]:
  ...
  mcp__ruflo@alpha__swarm_init { topology: "hierarchical", maxAgents: 8, strategy: "parallel" }
  mcp__ruflo@alpha__agent_spawn { type: "system-architect", name: "System Designer" }
  mcp__ruflo@alpha__agent_spawn { type: "coder", name: "API Developer" }
  mcp__ruflo@alpha__agent_spawn { type: "coder", name: "Auth Expert" }
  mcp__ruflo@alpha__agent_spawn { type: "code-analyzer", name: "DB Designer" }
  mcp__ruflo@alpha__agent_spawn { type: "tester", name: "Test Engineer" }
  mcp__ruflo@alpha__agent_spawn { type: "task-orchestrator", name: "Lead" }
  ...
  // Start orchestration
  mcp__ruflo@alpha__task_orchestrate { task: "Build REST API", strategy: "parallel" }

  // Store initial memory
  mcp__ruflo@alpha__memory_usage { action: "store", key: "project/init", value: { started: Date.now() } }
...
Message 1: mcp__ruflo@alpha__swarm_init
Message 2: mcp__ruflo@alpha__agent_spawn (just one agent)
Message 3: mcp__ruflo@alpha__agent_spawn (another agent)
Message 4: TodoWrite (single todo)
...
mcp__ruflo@alpha__memory_usage
  action: "store"
...
4. **Monitor Progress**: Use mcp**ruflo@alpha**swarm_monitor for real-time tracking
...
- Examples: https://github.com/snowzlm/ruflo@alpha/tree/main/examples

---

Remember: **Ruflo coordinates, OpenClaw creates!** Start with `mcp__ruflo@alpha__swarm_init` to enhance your development workflow.
