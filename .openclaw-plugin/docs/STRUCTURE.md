# Ruflo Plugin Structure

## Official OpenClaw Plugin Format

This plugin follows the official OpenClaw plugin specification.

## Directory Structure

```
claude-flow/
├── .openclaw-plugin/              # Plugin metadata and documentation
...
### Commands (`commands/`)
- Markdown files (.md)
- Automatically discovered by OpenClaw
...
- Integration with Ruflo coordination
