...
All documentation follows official OpenClaw plugin guidelines.
...
### Plugin Manifest
- **Format**: `.openclaw-plugin/plugin.json` (plugin configuration)
- **Marketplace**: `.openclaw-plugin/marketplace.json` (distribution metadata)
- **Schema**: Official OpenClaw plugin specification
...
- **Integration**: Ruflo coordination
...
- ✓ Official OpenClaw plugin specification
...
- OpenClaw plugin marketplace distribution
...
The plugin is configured via `.openclaw-plugin/plugin.json`:
...
```json
{
  ...
  "repository": {
    "type": "git",
    "url": "https://github.com/snowzlm/ruflo.git"
  },
  "mcpServers": {
    "ruflo": {
      "command": "npx",
...
**Version**: 2.5.0
**Specification**: OpenClaw Official Plugin Format
