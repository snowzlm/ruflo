...
if ! command -v claude &> /dev/null; then
    error "OpenClaw CLI not found. Please install it first:"
...
echo "     In OpenClaw, check available MCP tools"
echo ""

info "Available Commands:"
echo "  • 150+ slash commands in ~/.openclaw/commands/"
echo "  • 74+ specialized agents in ~/.openclaw/agents/"
