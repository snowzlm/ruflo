...
[![Core](https://img.shields.io/badge/Module-Core-blue.svg)](https://github.com/snowzlm/ruflo)

> Shared utilities, types, and core infrastructure for Ruflo V3 - the foundation module used by all other @claude-flow packages.
