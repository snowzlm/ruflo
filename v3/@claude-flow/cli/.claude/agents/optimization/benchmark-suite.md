...
npx ruflo benchmark-run --suite throughput --iterations 10

# Compare with baseline
npx ruflo benchmark-compare --current <results> --baseline <baseline>

# Quality assessment
npx ruflo quality-assess --target swarm-performance --criteria throughput,latency

# Performance validation
npx ruflo validate-performance --results <file> --criteria <file>
```

### Regression Detection Commands
```bash
# Detect performance regressions
npx ruflo detect-regression --current <results> --historical <data>

# Set up automated regression monitoring
npx ruflo regression-monitor --enable --sensitivity 0.95

# Analyze error patterns
npx ruflo error-analysis --logs <log-files>
```
