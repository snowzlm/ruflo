...
ruflo memory init --backend=hybrid --hnsw-enabled

# Memory health check
ruflo memory health

# Search memories
ruflo memory search -q "authentication patterns" --namespace="patterns"

# Consolidate memories
ruflo memory consolidate --strategy=hybrid --retention=0.7

# Export/import namespaces
ruflo memory export --namespace="project:myapp" --format=json
ruflo memory import --file="backup.json" --namespace="project:myapp"

# Memory statistics
ruflo memory stats --namespace="default"

# Quantization
ruflo memory quantize --namespace="embeddings" --method=int8
```
