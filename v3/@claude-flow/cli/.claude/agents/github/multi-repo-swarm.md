...
ruflo github link-prs --urls "$PR_URLS"
```
...
ruflo github multi-repo-refactor \
...
ruflo github multi-repo-security \
  --scan-all \
...
ruflo github multi-repo-dashboard \
  --port 3000 \
...
ruflo github parallel-optimize \
  --analyze-dependencies \
...
ruflo github diagnose-connectivity \
  --test-all-repos \
  --check-permissions \
  --verify-webhooks
```
