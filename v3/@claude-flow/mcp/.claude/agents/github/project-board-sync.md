...
ruflo github board-auto-assign \
...
# Process with swarm
ruflo github board-import-issues \
  --issues "$ISSUES" \
...
ruflo github release-plan-board \
  --analyze-velocity \
  --estimate-completion \
  --identify-risks \
  --optimize-scope
...
ruflo github review-coordinate \
  --board "Code Review" \
  --assign-reviewers \
  --track-feedback \
  --ensure-coverage
