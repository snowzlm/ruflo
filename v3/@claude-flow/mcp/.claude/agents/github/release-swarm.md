...
hooks:
  pre_task: |
    ...
    ruflo hook pre-task --mode release-swarm --init-swarm
  post_edit: |
    echo "🔄 Synchronizing release swarm state and validating changes..."
    ruflo hook post-edit --mode release-swarm --sync-swarm
  post_task: |
    echo "🎯 Release swarm task completed. Coordinating final deployment..."
    ruflo hook post-task --mode release-swarm --finalize-release
  notification: |
    echo "📡 Broadcasting release completion across all swarm agents..."
    ruflo hook notification --mode release-swarm --broadcast
---
...
CHANGELOG=$(gh api repos/:owner/:repo/compare/${LAST_TAG}...HEAD \
  ...
  ruflo github generate-changelog)
    ...
    steps:
      ...
      - name: Generate Release Assets
        run: |
          ...
          CHANGELOG=$(ruflo github release-changelog \
            --format markdown)
