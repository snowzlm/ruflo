...
npx ruflo sparc run tutorial "guide me through SPARC methodology"

# For alpha features
ruflo sparc run tutorial "guide me through SPARC methodology"

# With namespace
npx ruflo sparc run tutorial "your task" --namespace tutorial

# Non-interactive mode
npx ruflo sparc run tutorial "your task" --non-interactive
```
...
```bash
# Store mode-specific context
npx ruflo memory store "tutorial_context" "important decisions" --namespace tutorial

# Query previous work
npx ruflo memory query "tutorial" --limit 5
```
