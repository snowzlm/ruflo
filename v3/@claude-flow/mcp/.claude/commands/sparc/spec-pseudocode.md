...
npx ruflo sparc run spec-pseudocode "define payment flow requirements"

# For alpha features
ruflo sparc run spec-pseudocode "define payment flow requirements"

# With namespace
npx ruflo sparc run spec-pseudocode "your task" --namespace spec-pseudocode

# Non-interactive mode
npx ruflo sparc run spec-pseudocode "your task" --non-interactive
```
...
```bash
# Store mode-specific context
npx ruflo memory store "spec-pseudocode_context" "important decisions" --namespace spec-pseudocode

# Query previous work
npx ruflo memory query "spec-pseudocode" --limit 5
```
