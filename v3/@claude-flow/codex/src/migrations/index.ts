 ...
 *
 * Migration utilities for converting OpenClaw configurations to Codex format
 * Supports full OPENCLAW.md parsing with section extraction, skill conversion,
...
/**
 * Parsed settings from OPENCLAW.md content
 */
...
/**
 * Feature mappings between OpenClaw and Codex
 */
export const FEATURE_MAPPINGS: FeatureMapping[] = [
  {
    claudeCode: 'OPENCLAW.md',
    codex: 'AGENTS.md',
    status: 'mapped',
    notes: 'Main instruction file - content is portable',
  },
  {
    claudeCode: 'OPENCLAW.local.md',
...
/**
 * Hook keywords recognized in OPENCLAW.md
 */
const HOOK_KEYWORDS = [
  'pre-task',
  'post-task',
...
/**
 * Parse a OPENCLAW.md file completely
 */
...
/**
 * Analyze a OPENCLAW.md file for migration (simplified interface)
 */
...
/**
 * Generate AGENTS.md content from parsed OPENCLAW.md
 */
export function generateAgentsMdFromParsed(parsed: ParsedClaudeMd): string {
  ...
  lines.push('');
  lines.push('> Migrated from OPENCLAW.md by @claude-flow/codex');
  lines.push('');
...
/**
 * Generate config.toml from parsed OPENCLAW.md
 */
export function generateConfigTomlFromParsed(parsed: ParsedClaudeMd): string {
  const lines: string[] = [];
  lines.push('# Migrated from OPENCLAW.md');
  lines.push('# Generated by @claude-flow/codex');
  lines.push('');
...
/**
 * Migrate from OpenClaw (OPENCLAW.md) to Codex (AGENTS.md)
 */
...
export function generateMigrationReport(result: MigrationResult): string {
  ...
  if (result.mappings) {
    ...
    lines.push('');
    lines.push('| OpenClaw | Codex | Status | Notes |');
    lines.push('|-------------|-------|--------|-------|');
