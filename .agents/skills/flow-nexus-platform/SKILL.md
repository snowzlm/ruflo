...
mcp__flow-nexus__sandbox_create({
  template: "node", // node, python, react, nextjs, vanilla, base, openclaw
  name: "my-sandbox",
  env_vars: {
...
mcp__flow-nexus__sandbox_configure({
  ...
  anthropic_key: "sk-ant-..." // For OpenClaw integration
})
```
...
- **openclaw**: OpenClaw integrated environment
...
mcp__flow-nexus__execution_stream_subscribe({
  stream_type: "claude-flow-swarm", // openclaw, claude-flow-swarm, claude-flow-hive-mind, github-integration
...
mcp__flow-nexus__execution_files_list({
  stream_id: "stream_id",
  created_by: "ruflo", // openclaw, ruflo, git-clone, user
