...
### Review Code
```bash
npx ruflo github review --pr 123
```

### Manage Issues
```bash
npx ruflo github issues list --state open
npx ruflo github issues create --title "Bug: ..."
```

### Setup Workflow
```bash
npx ruflo workflow create --template ci
```

### Release Management
```bash
npx ruflo deployment release --version 1.0.0
```
