...
## Executive Summary
This document provides a complete migration plan for converting the existing command-based system (`.openclaw/commands/`) to the new intelligent agent-based system (`.openclaw/agents/`). The migration preserves all functionality while adding natural language understanding, intelligent coordination, and improved parallelization.
...
- Agent documentation: `.openclaw/agents/README.md`
- Migration guides: `.openclaw/agents/migration/`
- Example workflows: `.openclaw/agents/examples/`
