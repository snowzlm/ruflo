...
description: |
  V3 Integration Architect for deep agentic-flow@alpha integration. Implements ADR-001 to eliminate 10,000+ duplicate lines and build ruflo as specialized extension rather than parallel implementation.
---
