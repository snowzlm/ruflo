...
npx ruflo swarm "research AI trends in 2025" \
  --strategy research \
  --mode distributed \
  --max-agents 6 \
  --parallel \
...
npx ruflo swarm "build REST API with authentication" \
...
```bash
# Quick testing swarm
npx ruflo swarm "test application comprehensively" \
  --strategy testing \
  --mode star \
  --parallel \
  --timeout 600
...
mcp__ruflo__memory_backup({
  "path": "/workspaces/openclaw-flow/backups/swarm-memory.json"
})
```
...
- [Ruflo Documentation](https://github.com/snowzlm/ruflo)
- [Swarm Orchestration Guide](https://github.com/snowzlm/ruflo/wiki/swarm)
- [MCP Tools Reference](https://github.com/snowzlm/ruflo/wiki/mcp)
- [Performance Optimization](https://github.com/snowzlm/ruflo/wiki/performance)
