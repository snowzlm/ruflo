...
```
~/.openclaw/skills/                    # Personal skills location
└── my-skill/                        # Skill directory (MUST be at top level!)
    └── SKILL.md                     # REQUIRED: Main skill file
```

**IMPORTANT**: Skills MUST be directly under `~/.openclaw/skills/[skill-name]/`.
...
└── [your-skills]/
```
- **Path**: `~/.openclaw/skills/` or `$HOME/.openclaw/skills/`
...
```
<project-root>/.openclaw/skills/
└── [team-skills]/
```
- **Path**: `.openclaw/skills/` in project root
...
- [ ] Directory is DIRECTLY in `~/.openclaw/skills/[skill-name]/` or `.openclaw/skills/[skill-name]/`
