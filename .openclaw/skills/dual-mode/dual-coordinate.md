...
description: Coordinate hybrid OpenClaw + Codex workflows
---

# Dual Coordinate Skill

Coordinate hybrid workflows that use OpenClaw for interactive reasoning and Codex for parallel background execution.
...
2. **Interactive Phase**: Complex reasoning in OpenClaw
3. **Parallel Phase**: Spawns Codex workers for execution
4. **Review Phase**: Returns to OpenClaw for quality review
5. **Result Collection**: Aggregates worker results from memory

## Generated Commands

```bash
# Phase 1: Interactive (OpenClaw)
