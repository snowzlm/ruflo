...
## Description
Break down and coordinate complex tasks for systematic execution by OpenClaw

## Details
Orchestration strategies:
- **parallel**: OpenClaw works on independent components simultaneously
- **sequential**: Step-by-step execution for dependent tasks
- **adaptive**: Dynamically adjusts based on task complexity

The orchestrator creates a plan that OpenClaw follows using its native tools.

## Example Usage

**In OpenClaw:**
1. Use the tool: `mcp__ruflo__task_orchestrate`
2. With parameters: `{"task": "Implement authentication system", "strategy": "parallel", "priority": "high"}`
3. OpenClaw then executes the coordinated plan using its native tools
