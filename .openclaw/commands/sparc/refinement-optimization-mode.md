...
npx ruflo sparc run refinement-optimization-mode "optimize database queries"

# For alpha features
ruflo sparc run refinement-optimization-mode "optimize database queries"

# With namespace
npx ruflo sparc run refinement-optimization-mode "your task" --namespace refinement-optimization-mode

# Non-interactive mode
npx ruflo sparc run refinement-optimization-mode "your task" --non-interactive
```
...
```bash
# Store mode-specific context
npx ruflo memory store "refinement-optimization-mode_context" "important decisions" --namespace refinement-optimization-mode

# Query previous work
npx ruflo memory query "refinement-optimization-mode" --limit 5
```
