...
## Purpose
Coordinate OpenClaw's research activities for comprehensive, systematic exploration.
...
```
Sets up different analytical approaches for OpenClaw to use.
...
Remember: The swarm coordinates HOW OpenClaw researches, not WHAT it finds.

## CLI Usage
```bash
# Start research workflow via CLI
npx ruflo workflow research "modern web frameworks"

# Export research workflow
npx ruflo workflow export research --format json
```