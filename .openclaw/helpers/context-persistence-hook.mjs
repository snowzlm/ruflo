 ...
 *
 * Intercepts OpenClaw's PreCompact, SessionStart, and UserPromptSubmit
 ...
 * OPENCLAW.md, tool definitions, all messages, and everything Claude sees.
 *
...
async function doPreCompact() {
  ...
  // NOTE: OpenClaw 2.0.76 executePreCompactHooks uses executeHooksOutsideREPL
