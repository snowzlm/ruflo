...
// ============================================================================
// Import ALL OpenClaw memories from all projects into AgentDB
// ============================================================================

async function doImportAll() {
  log('Importing ALL OpenClaw memories into AgentDB...');
  ...
  if (!existsSync(claudeProjectsDir)) {
    dim('No OpenClaw projects found at ' + claudeProjectsDir);
    return;
  }
  ...
  success('All OpenClaw memories now searchable via AgentDB vector search');
}
...
// Ensure clean exit for OpenClaw hooks (exit 0 = success, no stderr = no error)
process.exit(0);
